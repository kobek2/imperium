  ...
  return (
    <section className="rounded border-2 border-rose-800 bg-rose-950/10 p-4">
      ...
      <p className="mt-2 max-w-2xl text-xs leading-relaxed text-[var(--psc-muted)]">
        Deletes all elections, votes, bills, role grants, economy ledger, fiscal years, inbox, world chat,
        cabinet/diplomacy/court records, and resets every character to citizen with $0 and 50% approval.
        Player accounts and character sheets (name, region, district, party) are kept.
      </p>
      {msg ? (
