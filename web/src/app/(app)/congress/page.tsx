  ...
  return (
    <div className="space-y-10">
      ...
      {(openHouseSessions.length > 0 || openSenateSessions.length > 0) && (
        <section className="rounded-lg border border-[var(--psc-border)] bg-[var(--psc-panel)] p-5">
          <h2 className="text-sm font-semibold text-[var(--psc-ink)]">Chamber leadership elections</h2>
          <p className="mt-1 text-xs text-[var(--psc-muted)]">
            Speaker, President Pro Tempore, majority and minority leaders and whips — file for one role in your
            chamber and vote on every role before the window closes. Ballots stay on each chamber&apos;s session page.
          </p>
