-- seed_election_npc_opponents referenced district_row fields on senate/president races
-- without SELECT INTO district_row first, causing: record "district_row" is not assigned yet.
...
begin
  ...
  dem_id := public._npc_insert_party_placeholder(
    ...
    incumbent_party, incumbent_name
  );
